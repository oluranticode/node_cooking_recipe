...
*/
  ...
  const infoErrorsObj = req.flash('infoErrors'); // error message
  const infoSubmitObj = req.flash('infoSubmit'); // success message
...
*/
  const SubmitRecipeOnPost = async(req, res) => {
    ...
    module.exports = {Homepage, Categories, ExploreRecipe, ExploreCategories,
                     SearchRecipe, ExploreLatest, ExploreRandom, SubmitRecipe, SubmitRecipeOnPost};
